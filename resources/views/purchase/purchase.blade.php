...
@section('container')
    ...
    <div class="container">
        ...
        @endif
        <form class="form-transaction" id="form-transaction" action="{{url('/purchase')}}" method="post">
            @csrf
            <div class="form-transaction-input">
                <label>Kode Pembelian</label>
                <input name="kode_pembelian" type="text" value="{{$purchase_code}}" readonly>
            </div>
            <input type="hidden" name="data" id="purchase">
            <div class="form-transaction-input">
                <label>Tanggal</label>
                <input name="tanggal_pembelian" type="date" value="{{date('Y-m-d')}}">
            </div>
            <div class="form-transaction-input">
...
<script>
    window.onload = () => {
        ...
        const renderList = (data) => {
            ...
            purchase.value = JSON.stringify(formData);
        }
        ...
        window.addEventListener('click',(event) => {
            if(event.target.classList.contains('btn-delete')){
                ...
                const tmpData = JSON.parse(purchase.value);
